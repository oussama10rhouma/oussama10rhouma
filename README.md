...
<!-- Animated header -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:6c63ff,100:3b82f6&height=220&section=header&text=Oussama%20Belhaj%20Rhouma&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Software%20Engineer%20|%20Data%20%E2%80%A2%20AI%20%E2%80%A2%20MLOps%20@%20T%C3%A9l%C3%A9com%20Paris&descSize=18&descAlignY=55&descAlign=50" width="100%" />

<!-- Typing SVG -->
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=80&lines=Building+intelligent+systems+at+scale+%F0%9F%9A%80;From+Full-Stack+to+AI+%E2%80%94+End-to-End+Engineering+%F0%9F%94%A7" alt="Typing SVG" /></a>
...
```python
class OussamaBelhajRhouma:
    def __init__(self):
        self.role       = "Software Engineer → Data/AI/MLOps Specialist"
        self.school     = "Télécom Paris — MS Expert Data, IA & MLOps"
        self.prev       = "Full-Stack Engineer @ Advanced Derivative Solutions"
        self.languages  = ["French 🇫🇷", "English 🇬🇧", "Arabic 🇹🇳"]
        self.interests  = ["Multi-Agent Systems", "RAG", "MLOps", "Distributed Computing"]
...
`Machine Learning` `Deep Learning` `NLP` `Generative AI` `RAG / GraphRAG` `Self-RAG` `CRAG` `Supervised Learning` `Unsupervised Learning` `Time Series` `Sentiment Analysis` `MLOps` `Data Science`

</details>

<details open>
<summary><strong>📡 Big Data & Cloud</strong></summary>
<br/>
...
`HDFS` `YARN` `HBase` `ZooKeeper` `PySpark` `Spark ML` `MapReduce` `S3` `GCS` `Azure`
...
`Spring Security` `Spring MVC` `Spring Data` `Hibernate` `PrimeNG` `Bootstrap` `jQuery` `SQL` `PL/SQL` `C` `C#` `PHP` `HTML/CSS`
...
`CI/CD` `Git` `MLflow` `Langfuse` `HBase` `MariaDB` `Oracle DB`
...
![GraphRAG](https://img.shields.io/badge/GraphRAG-8B5CF6?style=flat-square)
![FastMCP](https://img.shields.io/badge/FastMCP-FF6B6B?style=flat-square)
...
![HBase](https://img.shields.io/badge/HBase-34323B?style=flat-square)
![Spark ML](https://img.shields.io/badge/Spark_ML-E25A1C?style=flat-square)
...
![Distributed](https://img.shields.io/badge/Distributed_Systems-2D3748?style=flat-square)
...
<img src="https://github-readme-stats.vercel.app/api?username=oussama10rhouma&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=6c63ff&icon_color=6c63ff&text_color=c9d1d9" height="170" />
<img src="https://github-readme-streak-stats.herokuapp.com/?user=oussama10rhouma&theme=tokyonight&hide_border=true&background=0D1117&ring=6c63ff&fire=6c63ff&currStreakLabel=6c63ff" height="170" />

<br/>

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=oussama10rhouma&layout=compact&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=6c63ff&text_color=c9d1d9&langs_count=10" height="170" />
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/oussama10rhouma/oussama10rhouma/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oussama10rhouma/oussama10rhouma/output/github-snake.svg" />
  <img alt="github-snake" src="https://raw.githubusercontent.com/oussama10rhouma/oussama10rhouma/output/github-snake-dark.svg" />
</picture>
...
<img src="https://komarev.com/ghpvc/?username=oussama10rhouma&style=for-the-badge&color=6c63ff" />
